...
data = dict(
    ...
    train=dict(
        type='IrLandDataset',
        ann_file='datasets/Ir_Land/cross1/annotations/two_cats/train.json',
        img_prefix='datasets/Ir_Land/cross1/train/',
        pipeline=[
            dict(type='LoadMultiBandsImageFromFile', img_mode='1234'),
            dict(type='LoadAnnotations', with_bbox=True, with_mask=True),
            dict(
    ...
    val=dict(
        type='IrLandDataset',
        ann_file='datasets/Ir_Land/cross1/annotations/two_cats/val.json',
        img_prefix='datasets/Ir_Land/cross1/val/',
        pipeline=[
            dict(type='LoadMultiBandsImageFromFile', img_mode='1234'),
            dict(
                type='MultiScaleFlipAug',
    ...
    test=dict(
        type='IrLandDataset',
        ann_file='datasets/Ir_Land/cross2/annotations/two_cats/val.json',
        img_prefix='datasets/Ir_Land/cross2/val/',
        pipeline=[
            dict(type='LoadMultiBandsImageFromFile', img_mode='1234'),
            dict(
                type='MultiScaleFlipAug',
...
custom_hooks = [
    dict(
        type='EvalOnecatHook',
        ann_file='datasets/Ir_Land/cross1/annotations/one_cats/val.json')
]
